...
const submitSolution = async (req, res) => {
  try {
    ...
    // Call AI service for actual code analysis
const aiResp = await axios.post('http://localhost:5001/api/dsa/analyze-code', {
  code,
  language,
  questionId
});
...
const getHint = async (req, res) => {
  try {
    ...
    // Call AI service for smart hints
const aiResp = await axios.post('http://localhost:5001/api/dsa/generate-hint', {
  questionId,
  language,
  currentCode
});
const hint = aiResp.data.hint;
